...
import com.innovenso.townplanner.model.concepts.properties.{
  ...
  CanConfigureContext,
  CanConfigureDataProtectionConcerns,
  CanConfigureDescription,
  CanConfigureFatherTime,
  CanConfigureLinks,
  CanConfigureRequirements,
  CanConfigureSecurityImpact,
  HasContext,
  HasDataProtectionConcerns,
  HasDescription,
  HasFatherTime,
  HasLinks,
...
import com.innovenso.townplanner.model.concepts.relationships.{
  ...
  CanConfigureImpactSource,
  CanConfigureInfluenceTarget,
  CanConfigureRaciTarget,
  CanConfigureServingSource,
  CanConfigureStakeHolderTarget,
